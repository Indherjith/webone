...
let ticketCount = 0;
const ticketPrice = 300; // Adjust the ticket price as needed
...
buynow.addEventListener("click",(event)=>{
    ...
    event_Details.image = "https://i.ytimg.com/vi/33VjaD98siQ/hqdefault.jpg";
    event_Details.name = "GV Prakash Concert Paris 2024";
    event_Details.description = "Experience the magic of GV Prakash at his spectacular 2024 Trichy concert!";
    event_Details.venue = "Trichy Municipal Ground, Trichy. 18th July 2024."
